...
ethicalads_html = "ethicalads.html"
localtoc_html = "localtoc.html"
html_context = {
    "project_links": [
...
html_sidebars = {
    "index": ["project.html", localtoc_html, "searchbox.html", ethicalads_html],
    "**": [localtoc_html, "relations.html", "searchbox.html", ethicalads_html],
}
singlehtml_sidebars = {"index": ["project.html", localtoc_html, ethicalads_html]}
